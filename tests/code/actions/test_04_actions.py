...
def test_move_by_offset_from_element():
    driver = webdriver.Chrome()
    driver.get('https://awesomeqa.com/selenium/mouse_interaction.html')
...
def test_move_by_offset_from_viewport_origin_ab():
    driver = webdriver.Chrome()
    driver.get('https://awesomeqa.com/selenium/mouse_interaction.html')
...
def test_move_by_offset_from_current_pointer_ab():
    driver = webdriver.Chrome()
    driver.get('https://awesomeqa.com/selenium/mouse_interaction.html')
...
def test_drag_and_drop_onto_element():
    driver = webdriver.Chrome()
    driver.get('https://awesomeqa.com/selenium/mouse_interaction.html')
